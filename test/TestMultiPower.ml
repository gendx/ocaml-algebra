...
let tests =
  ...
  [
    "make" >:::
    [
      "(1)" >:: (fun test_ctxt -> assert_equal
          (MultiPower.make [])
          ([], 0)) ;
      "(2)" >:: (fun test_ctxt -> assert_equal
          (MultiPower.make [0,1])
          ([0,1], 1)) ;
      "(3)" >:: (fun test_ctxt -> assert_equal
          (MultiPower.make [0,1 ; 1,2])
          ([0,1 ; 1,2], 3)) ;
      "(4)" >:: (fun test_ctxt -> assert_equal
          (MultiPower.make [5,1 ; 3,3])
          ([3,3 ; 5,1], 4)) ;
      "(5)" >:: (fun test_ctxt -> assert_equal
          (MultiPower.make [4,0])
          ([], 0)) ;
      "(6)" >:: (fun test_ctxt -> assert_equal
